...
import { Calendar, Download, FileDown, BarChart2, PieChart, TrendingUp, Users, MessageSquare, Heart, Repeat, Star } from "lucide-react";
import {
  AreaChart,
  Area,
  XAxis,
...
export default function Analytics() {
  ...
  const { data: statsData, isLoading: statsLoading } = useQuery({
    ...
    queryFn: () => fetch(`/api/users/${userId}/stats?period=${period}`).then((res) => res.json()),
  });

  const handleExport = async (format: string) => {
    try {
      await apiRequest("GET", `/api/users/${userId}/stats/export?format=${format}`, undefined);
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-6 space-y-6">
                ...
                <div className="flex gap-3 mt-4 sm:mt-0">
                  <div className="text-center px-2">
                    ...
                    <div className="text-xl font-bold text-primary-600 dark:text-primary-400">
                      {userLoading ? <Skeleton className="h-6 w-16 mx-auto" /> : userData?.totalPoints}
                    </div>
                  </div>
                  
                  <div className="text-center px-2 border-l border-gray-200 dark:border-gray-700">
                    <div className="text-sm font-medium text-gray-500 dark:text-gray-400">Followers</div>
                    <div className="text-xl font-bold text-gray-900 dark:text-gray-100">
                      {userLoading ? <Skeleton className="h-6 w-16 mx-auto" /> : userData?.followerCount}
                    </div>
                  </div>
                  
                  <div className="text-center px-2 border-l border-gray-200 dark:border-gray-700">
                    <div className="text-sm font-medium text-gray-500 dark:text-gray-400">Following</div>
                    <div className="text-xl font-bold text-gray-900 dark:text-gray-100">
                      {userLoading ? <Skeleton className="h-6 w-16 mx-auto" /> : userData?.followingCount}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <Tabs defaultValue="overview" className="space-y-4">
                  ...
                  <>
                    <Card>
                      <CardContent className="p-6">
                        <div className="flex justify-between items-start">
                          <div>
                            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Total Casts</p>
                            <h3 className="text-2xl font-bold mt-1 text-gray-900 dark:text-gray-100">
                              {timeSeriesData.reduce((sum, item) => sum + item.casts, 0)}
                            </h3>
                          </div>
                    ...
                    <Card>
                      <CardContent className="p-6">
                        <div className="flex justify-between items-start">
                          <div>
                            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Reactions</p>
                            <h3 className="text-2xl font-bold mt-1 text-gray-900 dark:text-gray-100">
                              {timeSeriesData.reduce((sum, item) => sum + item.reactions, 0)}
                            </h3>
                          </div>
                      ...
                      <CardContent className="p-6">
                        <div className="flex justify-between items-start">
                          <div>
                            ...
                            <h3 className="text-2xl font-bold mt-1 text-gray-900 dark:text-gray-100">
                              {timeSeriesData.reduce((sum, item) => sum + item.replies, 0)}
                            </h3>
                          </div>
                    ...
                    <Card>
                      <CardContent className="p-6">
                        <div className="flex justify-between items-start">
                          <div>
                            <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Recasts</p>
                            <h3 className="text-2xl font-bold mt-1 text-gray-900 dark:text-gray-100">
                              {timeSeriesData.reduce((sum, item) => sum + item.recasts, 0)}
                            </h3>
                          </div>
                    ...
                    {statsLoading ? (
                      ...
                      <div className="h-72">
                        <ResponsiveContainer width="100%" height="100%">
                          ...
                          >
                            <defs>
                              <linearGradient id="colorCasts" x1="0" y1="0" x2="0" y2="1">
                    ...
                    <div className="h-72">
                      <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                          ...
                          <Tooltip />
                          <Legend />
                          <Bar dataKey="casts" name="Casts" fill="#6366f1" radius={[4, 4, 0, 0]} />
                          <Bar dataKey="replies" name="Replies" fill="#22c55e" radius={[4, 4, 0, 0]} />
                          <Bar dataKey="reactions" name="Reactions" fill="#f59e0b" radius={[4, 4, 0, 0]} />
                          <Bar dataKey="recasts" name="Recasts" fill="#0ea5e9" radius={[4, 4, 0, 0]} />
                        </BarChart>
                      </ResponsiveContainer>
                    </div>
                  )}
                    ...
                    {statsLoading ? (
                      ...
                      <div className="divide-y divide-gray-200 dark:divide-gray-700">
                        <div className="p-4 flex items-center">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between">
                              <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100">Web3 Analytics Tools</h4>
                              <span className="text-sm text-primary-600 dark:text-primary-400">+124 pts</span>
                            </div>
                        ...
                        <div className="p-4 flex items-center">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between">
                              <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100">Farcaster Development Updates</h4>
                              <span className="text-sm text-primary-600 dark:text-primary-400">+98 pts</span>
                            </div>
                            <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 mt-1">
                        ...
                        <div className="p-4 flex items-center">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between">
                              <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100">Community Building Strategies</h4>
                              <span className="text-sm text-primary-600 dark:text-primary-400">+87 pts</span>
                            </div>
                            <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 mt-1">
                        ...
                        <div className="p-4 flex items-center">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between">
                              <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100">NFT Market Trends</h4>
                              <span className="text-sm text-primary-600 dark:text-primary-400">+72 pts</span>
                            </div>
                            <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 mt-1">
                        ...
                        <div className="p-4 flex items-center">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between">
                              <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100">DeFi Innovations</h4>
                              <span className="text-sm text-primary-600 dark:text-primary-400">+65 pts</span>
                            </div>
                            <div className="flex items-center text-xs text-gray-500 dark:text-gray-400 mt-1">
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Cast Engagement</span>
                          </div>
                          <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">
                            {Math.round(timeSeriesData.reduce((sum, item) => sum + item.casts, 0) / timeSeriesData.length)} per period
                          </span>
                        </div>
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Reaction Rate</span>
                          </div>
                          <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">
                            {Math.round(timeSeriesData.reduce((sum, item) => sum + item.reactions, 0) / timeSeriesData.length)} per period
                          </span>
                        </div>
                        <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden dark:bg-gray-700">
                          <motion.div 
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Reply Activity</span>
                          </div>
                          <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">
                            {Math.round(timeSeriesData.reduce((sum, item) => sum + item.replies, 0) / timeSeriesData.length)} per period
                          </span>
                        </div>
                        <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden dark:bg-gray-700">
                          <motion.div 
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center">
                            ...
                            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Recast Frequency</span>
                          </div>
                          <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">
                            {Math.round(timeSeriesData.reduce((sum, item) => sum + item.recasts, 0) / timeSeriesData.length)} per period
                          </span>
                        </div>
                        <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden dark:bg-gray-700">
                          <motion.div 
            ...
            <TabsContent value="trend" className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 dark:divide-gray-700">
                    <div className="p-6 text-center">
                      <div className="text-3xl font-bold text-gray-900 dark:text-gray-100">
                        {statsLoading ? <Skeleton className="h-10 w-20 mx-auto" /> : "+15%"}
                      </div>
                      <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Follower Growth</p>
                    ...
                    <div className="p-6 text-center">
                      <div className="text-3xl font-bold text-gray-900 dark:text-gray-100">
                        {statsLoading ? <Skeleton className="h-10 w-20 mx-auto" /> : "+24%"}
                      </div>
                      <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Engagement Rate</p>
                      <div className="flex justify-center mt-3">
                        <span className="text-xs px-2 py-1 bg-green-100 text-green-600 dark:bg-green-900 dark:text-green-300 rounded-full">
                          Above Average
                        </span>
                    ...
                    <div className="p-6 text-center">
                      <div className="text-3xl font-bold text-gray-900 dark:text-gray-100">
                        {statsLoading ? <Skeleton className="h-10 w-20 mx-auto" /> : "+8%"}
                      </div>
                      <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Points Growth</p>
                      <div className="flex justify-center mt-3">
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg font-semibold">Historical Comparison</CardTitle>
                </CardHeader>
                <CardContent>
                  {statsLoading ? (
            ...
            <TabsContent value="comparison" className="space-y-4">
                  ...
                  <div className="space-y-8">
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">78/100</span>
                      </div>
                      <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden dark:bg-gray-700">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Activity Frequency</span>
                        <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">86/100</span>
                      </div>
                      <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden dark:bg-gray-700">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Growth Rate</span>
                        <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">64/100</span>
                      </div>
                      <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden dark:bg-gray-700">
                    ...
                    <div>
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-sm font-semibold text-gray-900 dark:text-gray-100">92/100</span>
                      </div>
                      <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden dark:bg-gray-700">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <Card>
                  <CardHeader>
                    <CardTitle className="text-lg font-semibold">Performance Percentile</CardTitle>
                  </CardHeader>
                  <CardContent>
                      ...
                      {statsLoading ? (
                        ...
                        <>
                          <div className="text-center">
                            <h2 className="text-5xl font-bold text-primary-500">Top 15%</h2>
                            <p className="text-gray-500 dark:text-gray-400 mt-2">of all Farcaster users</p>
                          </div>
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                          ...
                          >
                            ...
                            <Line 
                              ...
                              strokeDasharray="5 5"
                              connectNulls
                              dataKey={(entry: any) => Math.round(entry.engagementRate * 0.7)}
                            />
                          </LineChart>
                        </ResponsiveContainer>
                      </div>
