...
export default function Dashboard({ user }: DashboardProps) {
	...
	const isLoading = warpcastLoading || isLoadingUser
	const hasError = warpcastError || userError
	const hasData = warpcastUser && userData

	// Log the state
	clientLog('info', 'Dashboard state:', {
		isLoading,
		hasError,
		hasData,
		warpcastLoading,
		isLoadingUser,
		hasWarpcastUser: !!warpcastUser,
